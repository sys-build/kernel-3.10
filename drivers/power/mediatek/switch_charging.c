...
#else
kal_uint32 temp_input_current[] = {CHARGE_CURRENT_500_00_MA, CHARGE_CURRENT_1000_00_MA, CHARGE_CURRENT_1500_00_MA};
kal_uint32 temp_current[] = {CHARGE_CURRENT_500_00_MA, CHARGE_CURRENT_1350_00_MA, CHARGE_CURRENT_1750_00_MA};
#ifdef A51CML_BATT
kal_uint32 temp_vin_dpm[] = {4280, 4280, 4280};
#else
kal_uint32 temp_vin_dpm[] = {4520, 4520, 4200};
#endif
kal_uint32 temp_avg_voltage[] = {0, 0, 0, 0, 0, 0};
...
#ifdef HTC_ENABLE_AICL
extern kal_uint16 htc_charging_avg_voltage_check();
#endif
...
static void pchr_turn_on_charging(void)
{
	...
	kal_uint32 charging_enable = KAL_TRUE;
		...
		int i = 0;
		#if defined(A51CML_BATT)
		kal_uint32 bad_cable_R1,bad_cable_R2,bad_cable_R3;
		kal_uint32 bad_cable_current[] = {CHARGE_CURRENT_500_00_MA,CHARGE_CURRENT_150_00_MA,CHARGE_CURRENT_100_00_MA};
...
#if 1 /* htc: set cv voltage through battery temperature, we add in htc_batt_temp_cv_set */
			/*Set CV Voltage */
#if !defined(CONFIG_MTK_JEITA_STANDARD_SUPPORT)
#ifdef HIGH_BATTERY_VOLTAGE_SUPPORT
...
PMU_STATUS BAT_BatteryFullAction(void)
{
	...
	if(BMT_status.keep_charger_on)
	...
	else
		{
			kal_uint32 charging_enable = KAL_FALSE;
			battery_charging_control(CHARGING_CMD_ENABLE, &charging_enable);
			battery_charging_control(CHARGING_CMD_POWERPATH_CTRL, &charging_enable);
		}

...
static void lcm_init(void)
{
  unsigned int data_array[35];
	...
	data_array[0] = 0x1a051500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x10061500;
	dsi_set_cmdq(data_array, 1, 1);
	...
	data_array[0] = 0x114f1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x11501500;
	dsi_set_cmdq(data_array, 1, 1);
	...
	data_array[0] = 0x1b861500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x39871500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x1b881500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x39891500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x20B51500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x018c1500;
	dsi_set_cmdq(data_array, 1, 1);
	...
	data_array[0] = 0x74781500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00791500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xa57a1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x007b1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xbe7c1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x007d1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xd07e1500;
	dsi_set_cmdq(data_array, 1, 1);
	...
	data_array[0] = 0x05861500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x01871500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x2f881500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x01891500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x568a1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x018b1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x848c1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x018d1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xb28e1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x018f1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xf2901500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02911500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x25921500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02931500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x26941500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02951500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x57961500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02971500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x8a981500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02991500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xae9a1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x029b1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xe99c1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x039d1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x069e1500;
	dsi_set_cmdq(data_array, 1, 1);
	...
	data_array[0] = 0x41a31500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03a41500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x51a51500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03a61500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x63a71500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03a91500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x71aa1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03ab1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x9aac1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03ad1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xbaae1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03af1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xceb01500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03b11500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xd0b21500;
	dsi_set_cmdq(data_array, 1, 1);
	...
	data_array[0] = 0x74b61500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00b71500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xa5b81500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00b91500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xbeba1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00bb1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xd0bc1500;
	dsi_set_cmdq(data_array, 1, 1);
	...
	data_array[0] = 0xedc01500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00c11500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xfac21500;
	dsi_set_cmdq(data_array, 1, 1);
	...
	data_array[0] = 0x2fc61500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x01c71500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x56c81500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x01c91500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x84ca1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x01cb1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xb2cc1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x01cd1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xf2ce1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02cf1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x25d01500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02d11500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x26d21500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02d31500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x57d41500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02d51500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x8ad61500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02d71500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xaed81500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02d91500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xe9da1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03db1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x06dc1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03dd1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x33de1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03df1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x41e01500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03e11500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x51e21500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03e31500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x63e41500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03e51500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x71e61500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03e71500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x9ae81500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03e91500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xbaea1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03eb1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xceec1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03ed1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xd0ee1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00ef1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x01f01500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00f11500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x74f21500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00f31500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xa5f41500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00f51500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xbef61500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00f71500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xd0f81500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00f91500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xdffa1500;
	dsi_set_cmdq(data_array, 1, 1);
	...
	data_array[0] = 0xed011500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00021500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xfa031500;
	dsi_set_cmdq(data_array, 1, 1);
	...
	data_array[0] = 0x2f071500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x01081500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x56091500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x010a1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x840b1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x010c1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xb20d1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x010e1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xf20f1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02101500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x25111500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02121500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x26131500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02141500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x57151500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02161500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x8a171500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02181500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xae191500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x021a1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xe91b1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x031c1500;
	dsi_set_cmdq(data_array, 1, 1);
	...
	data_array[0] = 0x51231500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03241500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x63251500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03261500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x76271500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03281500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x9a291500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x032a1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xba2b1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x032d1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xce2f1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03301500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xd0311500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00321500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x01331500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00341500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x74351500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00361500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xa5371500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00381500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xbe391500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x003a1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xd03b1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x003d1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xdf3f1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00401500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xed411500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00421500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xfa431500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x01441500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x05451500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x01461500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x2f471500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x01481500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x56491500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x014a1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x844b1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x014c1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xb24d1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x014e1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xf24f1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02501500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x25511500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02521500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x26531500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02541500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x57551500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02561500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x8a581500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02591500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xae5a1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x025b1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xe95c1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x035d1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x065e1500;
	dsi_set_cmdq(data_array, 1, 1);
	...
	data_array[0] = 0x41621500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03631500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x51641500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03651500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x63661500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03671500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x76681500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03691500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x9a6a1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x036b1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xba6c1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x036d1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xce6e1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x036f1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xd0701500;
	dsi_set_cmdq(data_array, 1, 1);
	...
	data_array[0] = 0x74741500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00751500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xa5761500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00771500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xbe781500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00791500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xd07a1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x007b1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xdf7c1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x007d1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xed7e1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x007f1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xfa801500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x01811500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x05821500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x01831500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x2f841500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x01851500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x56861500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x01871500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x84881500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x01891500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xb28a1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x018b1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xf28c1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x028d1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x258e1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x028f1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x26901500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02911500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x57921500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02931500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x8a941500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02951500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xae961500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02971500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xe9981500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03991500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x069a1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x039b1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x339c1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x039d1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x419e1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x039f1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x51a01500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03a21500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x63a31500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03a41500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x77a51500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03a61500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x9aa71500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03a91500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xbaaa1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03ab1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xceac1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03ad1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xd0ae1500;
	dsi_set_cmdq(data_array, 1, 1);
	...
	data_array[0] = 0x74b21500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00b31500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xa5b41500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00b51500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xbeb61500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00b71500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xd0b81500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00b91500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xdfba1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00bb1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xedbc1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x00bd1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xfabe1500;
	dsi_set_cmdq(data_array, 1, 1);
	...
	data_array[0] = 0x2fc21500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x01c31500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x56c41500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x01c51500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x84c61500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x01c71500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xb2c81500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x01c91500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xf2ca1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02cb1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x25cc1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02cd1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x26ce1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02cf1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x57d01500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02d11500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x8ad21500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02d31500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xaed41500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x02d51500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xe9d61500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03d71500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x06d81500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03d91500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x33da1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03db1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x41dc1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03dd1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x51de1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03df1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x63e01500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03e11500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x77e21500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03e31500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x9ae41500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03e51500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xbae61500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03e71500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xcee81500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0x03e91500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0] = 0xd0ea1500;
	dsi_set_cmdq(data_array, 1, 1);
...
LCM_DRIVER nt35596_fhd_dsi_vdo_truly_tps65132_a51c_drv =
{
    .name           = "nt35596_fhd_dsi_vdo_truly_tps65132_a51c",

...
*/
        ...
        case EVENT_ID_GSCAN_FULL_RESULT:  
        {
            ...
            if (prEventGscnFullResultl)
				memcpy(prEventGscnFullResultl,
						(P_WIFI_GSCAN_RESULT_T)(prEvent->aucBuffer),
						sizeof(WIFI_GSCAN_RESULT_T) );
                
            prParamGscnFullResultl = kalMemAlloc( sizeof(PARAM_WIFI_GSCAN_RESULT), VIR_MEM_TYPE );
            if (prParamGscnFullResultl && prEventGscnFullResultl) {
    ...
    )
{
...
#if 1 //CFG_RX_PKTS_DUMP
    {
        ...
        //    	  u2TxFrameCtrl == MAC_FRAME_PROBE_RSP) {
                ...
                DBGLOG(RX, TRACE, ("QM RX MGT: net %u sta idx %u wlan idx %u ssn %u ptype %u subtype %u 11 %u\n",

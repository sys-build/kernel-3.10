    ...
    )
{
    ...
    for(i = 0 ; i < prP2PInfo->u4DeviceNum ; i++) {
        ...
        if (1) {
            ...
            snprintf(data, sizeof(data), "p2p_cap=%02x%02x%02x%02x%c",
            ...
            snprintf(data, sizeof(data), "p2p_dev_type=%02x%02x%02x%02x%02x%02x%c",
            ...
            snprintf(data, sizeof(data), "p2p_grp_bssid="MACSTR"%c",

        ...
        if(prAdapter->fgIsP2PRegistered) {
            ...
            */
            if (prBssDesc->eBand == BAND_5G &&
                ...
                DBGLOG(SCN, WARN, ("P2P: scanned BSS on 5G channel while 5G not support, ignore it!\n"));
                return rStatus;
            }
    ...
    )
{
    ...
    LINK_FOR_EACH_ENTRY(prBssDesc, prBSSDescList, rLinkEntry, BSS_DESC_T) {
        ...
        DBGLOG(SCN, TRACE, ("SEARCH: ["MACSTR"], SSID:%s\n",
        ...
        if (CHECK_FOR_TIMEOUT(rCurrentTime, prBssDesc->rUpdateTime,
			...
			{
				DBGLOG(SCN, INFO, ("SEARCH: Ignore ["MACSTR"] SCN_BSS_DESC_REMOVE_TIMEOUT_SEC\n",

...
static INT32 wmt_dbg_stop_dump_fwinfo(INT32 par1, INT32 par2, INT32 par3);
...
INT32 wmt_dbg_stop_dump_fwinfo(INT32 par1, INT32 par2, INT32 par3)
{
	isBreak = MTK_WCN_BOOL_FALSE;
	WMT_INFO_FUNC("stop dump fw information cmd!!\n");
    return 0;
}
INT32 wmt_dbg_fwinfor_from_emi(INT32 par1, INT32 par2, INT32 par3)
{
    ...
    if(offset == 1){        
        do {
			...
			if (pAddr == NULL) {
				printk("\n\n -- wmt plat get emi virt add is NULL --\n\n");
				continue;
			}

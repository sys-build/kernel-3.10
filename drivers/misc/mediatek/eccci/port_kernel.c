...
//#define MD_STATUS_POLLING_TIMEOUT 5//original MTK timeout value
#define MD_STATUS_POLLING_TIMEOUT 15//SSD_RIL--Enlarged to 15s to avoid system busy problem.
//static inline void ccci_debug_scan_busy_tasks()
/*+SSD_RIL*/
...
void md_status_poller_func(unsigned long data)
{
    ...
    mod_timer(&md->md_status_timeout, jiffies + MD_STATUS_POLLING_TIMEOUT*HZ);//SSD_RIL

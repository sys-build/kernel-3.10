...
#define EXCP_CTRL_CH_ID		11
#define EXCP_MSG_CH_ID		3
#define EXCP_DATA_CH_ID		9
#define CCMNI_AP_LOOPBACK_CH	(15)
#endif

#define HEART_BEAT_TIMEOUT		(15000)		//ms
#define POLLING_INTERVAL		(20000)		//ms
...
#define ONE_PACKET_MAX_SIZE			(10*1024)

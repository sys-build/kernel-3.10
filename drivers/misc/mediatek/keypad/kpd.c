...
//struct my_attribute vol_wakeup = __ATTR(0666, vol_wakeup_show, vol_wakeup_store);
...
#ifdef CONFIG_VOLDOWN_CHANGE
	mt_set_gpio_mode(GPIO_KPD_KCOL1_PIN, 1);
	mt_set_gpio_dir(GPIO_KPD_KCOL1_PIN, 0);
	mt_set_gpio_pull_enable(GPIO_KPD_KCOL1_PIN, 1);

...
static int slp_suspend_ops_enter(suspend_state_t state)
{
    ...
    mt6328_set_register_value(PMIC_RG_VGP1_MODE_CTRL,1);
...
#endif
    pmic_ldo_enable(MT6328_POWER_LDO_VGP1, 0);

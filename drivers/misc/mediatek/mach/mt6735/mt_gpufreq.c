...
static bool mt_gpufreq_fix_freq_for_usb_audio;
/******************************
 ...
 *************************************************/
void mt_gpufreq_is_playing_usb_audio(bool onoff)
{
	mt_gpufreq_fix_freq_for_usb_audio = (onoff) ? true:false;
}
...
#endif
    if (mt_gpufreq_fix_freq_for_usb_audio == true) {
            target_freq = mt_gpufreqs[g_limited_min_id].gpufreq_khz;
            target_volt = mt_gpufreqs[g_limited_min_id].gpufreq_volt;
            target_OPPidx = g_limited_min_id;
            gpufreq_dbg("Limit! Limit gpu frequency %d when playing USB audio\n",
                mt_gpufreqs[g_limited_min_id].gpufreq_khz);

...
static const u32 sodi_binary[] = {
	...
	0xa1de8407, 0xa1df0407, 0xc2003880, 0x1211041f, 0x1b00001f, 0xaf7cefff,
	...
	0xc2003880, 0x1211841f, 0x1b00001f, 0x6f7ce7ff, 0xf0000000, 0x17c07c1f,
	0x81459801, 0xd8001845, 0x17c07c1f, 0x1a00001f, 0x10006604, 0xe2200004,
	0xc0c030e0, 0x17c07c1f, 0xc0c031c0, 0x1093041f, 0xe2200003, 0xc0c030e0,
	0x17c07c1f, 0xc0c031c0, 0x1093041f, 0xe2200002, 0xc0c030e0, 0x17c07c1f,
	0xc0c031c0, 0x1093041f, 0x80378400, 0xc2003880, 0x1210041f, 0x1b00001f,
	...
	0x1093041f, 0xe2200004, 0xc0c030e0, 0x17c07c1f, 0xc0c031c0, 0x1093041f,
	0xe2200005, 0xc0c030e0, 0x17c07c1f, 0xc0c031c0, 0x1093041f, 0xc2003880,
	...
	0xc0c030e0, 0x17c07c1f, 0xc0c031c0, 0x1093041f, 0xe2200003, 0xc0c030e0,
	0x17c07c1f, 0xc0c031c0, 0x1093041f, 0xe2200002, 0xc0c030e0, 0x17c07c1f,
	0xc0c031c0, 0x1093041f, 0x1a00001f, 0x100062c4, 0x1890001f, 0x100062c4,
	...
	0xc0c030e0, 0x17c07c1f, 0xc0c031c0, 0x1093041f, 0xe2200004, 0xc0c030e0,
	0x17c07c1f, 0xc0c031c0, 0x1093041f, 0xe2200005, 0xc0c030e0, 0x17c07c1f,
	0xc0c031c0, 0x1093041f, 0x1b00001f, 0x00000801, 0xf0000000, 0x17c07c1f,
	...
	0xf0000000, 0x17c07c1f, 0x81499801, 0xd8203325, 0x17c07c1f, 0xd8203842,
	0x17c07c1f, 0x18d0001f, 0x40000000, 0x18d0001f, 0x70000000, 0xd8003222,
	0x00a00402, 0x814a1801, 0xd8203485, 0x17c07c1f, 0xd8203842, 0x17c07c1f,
	0x18d0001f, 0x40000000, 0x18d0001f, 0x80000000, 0xd8003382, 0x00a00402,
	0x814a9801, 0xd82035e5, 0x17c07c1f, 0xd8203842, 0x17c07c1f, 0x18d0001f,
	0x40000000, 0x18d0001f, 0xc0000000, 0xd80034e2, 0x00a00402, 0x814c1801,
	0xd8203745, 0x17c07c1f, 0xd8203842, 0x17c07c1f, 0x18d0001f, 0x40000000,
	0x18d0001f, 0xa0000000, 0xd8003642, 0x00a00402, 0xd8203842, 0x17c07c1f,
	0x18d0001f, 0x40000000, 0x18d0001f, 0x40000000, 0xd8003742, 0x00a00402,
	...
	0x18c0001f, 0x100062dc, 0xe0c00001, 0xc2003880, 0x1212041f, 0x81469801,
	...
	0x17c07c1f, 0xe220000b, 0xc0c07180, 0x12807c1f, 0xc0c030e0, 0x17c07c1f,
	0xc2003880, 0x1214041f, 0xd0005140, 0x17c07c1f, 0xc0c030e0, 0xe2200006,
	0xc0c030e0, 0xe2200001, 0xa1d38407, 0xa0108400, 0xa0148400, 0xa01b8400,
	...
	0x17c07c1f, 0x814f9801, 0xd80058a5, 0x17c07c1f, 0x80c78001, 0xc8c015c3,
	...
	0xc0c030e0, 0x17c07c1f, 0xd0005d60, 0x17c07c1f, 0xc0c030e0, 0xe2200008,
	...
	0x44bb44bb, 0xc2003880, 0x1213841f, 0x18c0001f, 0x10006b14, 0xe0c0000c,
	...
	0x100062c4, 0x80841001, 0xc8e02ce2, 0x17c07c1f, 0xd00067e0, 0x17c07c1f,
...
static struct pcm_desc sodi_pcm = {
	.version	= "pcm_sodi_v0.2.4.8_20150811-slow_dvs",
	.base		= sodi_binary,
	.size		= 942,
	.sess		= 2,
	.replace	= 0,
...
static unsigned long int sodi_logout_prev_time = 0;
static int pre_emi_refresh_cnt = 0;
static int memPllCG_prev_status = 1; //1:CG, 0:pwrdn
static const char *sodi_wakesrc_str[32] = SPM_WAKE_SRC_LIST;
static unsigned int logout_sodi_cnt = 0;
static unsigned int logout_selfrefresh_cnt = 0;
#endif //REDUCE_SODI_LOG
...
void spm_go_to_sodi(u32 spm_flags, u32 spm_data)
{
 ...
 //   sodi_debug("emi-selfrefrsh cnt = %d, pcm_flag = 0x%x, SPM_PCM_RESERVE2 = 0x%x, %s\n", spm_read(SPM_PCM_PASR_DPD_3), spm_read(SPM_PCM_FLAGS), spm_read(SPM_PCM_RESERVE2), pcmdesc->version);
	...
	else if ( (spm_read(SPM_PCM_PASR_DPD_3) == 0 && pre_emi_refresh_cnt > 0) || (spm_read(SPM_PCM_PASR_DPD_3) > 0 && pre_emi_refresh_cnt == 0) ) 
	{ 
		need_log_out = 1;
	}
	else if ((sodi_logout_curr_time - sodi_logout_prev_time) > sodi_logout_critera) //previous logout time > sodi_logout_critera
	{
        need_log_out = 1;
    }
    else //check CG/pwrdn status is changed
    {
        ...
        if ( ((spm_read(SPM_PCM_FLAGS)&0x40) != 0) || ((spm_read(SPM_PCM_RESERVE2)&0x80) != 0) )
        {
            mem_status = 1;
        }
    ...
    if (need_log_out == 1)
    {
        ...
        if (wakesta.assert_pc != 0) 
        {
            sodi_err("emi-selfrefrsh cnt = %d, pcm_flag = 0x%x, PCM_RESERVE2 = 0x%x, vcore_status = %d, logout_sodi_cnt =%d, logout_selfrefresh_cnt = %d\n", spm_read(SPM_PCM_PASR_DPD_3), spm_read(SPM_PCM_FLAGS), spm_read(SPM_PCM_RESERVE2), vcore_status, logout_sodi_cnt, logout_selfrefresh_cnt);
            sodi_err("wake up by SPM assert, spm_pc = 0x%0x, r12 = 0x%x, r13 = 0x%x, debug_flag = 0x%x, %s\n", wakesta.assert_pc, wakesta.r12, wakesta.r13, wakesta.debug_flag, pcmdesc->version); 
            sodi_err("raw_sta = 0x%x, idle_sta = 0x%x, event_reg = 0x%x, isr = 0x%x\n", wakesta.raw_sta, wakesta.idle_sta, wakesta.event_reg, wakesta.isr);
        }
        else
        {
            ...
            sodi_debug("emi-selfrefrsh cnt = %d, pcm_flag = 0x%x, PCM_RESERVE2 = 0x%x, vcore_status = %d, logout_sodi_cnt = %d, logout_selfrefresh_cnt = %d\n", spm_read(SPM_PCM_PASR_DPD_3), spm_read(SPM_PCM_FLAGS), spm_read(SPM_PCM_RESERVE2), vcore_status, logout_sodi_cnt, logout_selfrefresh_cnt);
            sodi_debug("wake up by %s, timer_out = %u, r12 = 0x%x, r13 = 0x%x, debug_flag = 0x%x, %s\n", buf, wakesta.timer_out, wakesta.r12, wakesta.r13, wakesta.debug_flag, pcmdesc->version);
            sodi_debug("raw_sta = 0x%x, idle_sta = 0x%x, event_reg = 0x%x, isr = 0x%x\n",  wakesta.raw_sta, wakesta.idle_sta, wakesta.event_reg, wakesta.isr);
        }

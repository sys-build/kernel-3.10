...
struct rt5506_config_data {
	...
	struct rt5506_comm_data cmd_data[PLAYBACK_MAX_MODE];  /* [mode][mode_kind][reserve][cmds..] */
};
...
#define AMP_SET_PARAM       _IOW(AMP_IOCTL_MAGIC, 0x04,  struct rt5506_config_data)
